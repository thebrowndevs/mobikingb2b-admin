...
function page() {
    ...
    const { data: returnReqOrders, isFetching, isLoading, error } = getCancelRequestOrders({
        requestType: 'Return',
        startDate,
        endDate,
        page,
    ...
    const pendingCount = returnReqOrders?.pendingCount || 0;
    const acceptedCount = returnReqOrders?.acceptedCount || 0;
    const rejectedCount = returnReqOrders?.rejectedCount || 0;
    const totalCount = returnReqOrders?.totalCount || 0;
