        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[580px] bg-back2 border border-bdr2 shadow-none rounded-xl">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-xs text-slate-455 font-medium">
                        Configure manufacturing names, status settings, and trademark logos.
                    </DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 py-4 items-stretch">
                        ...
                        <div className="flex flex-col justify-between gap-4">
                            ...
                            {/* Active */}
                            <div className="flex items-center justify-between p-2.5 border border-bdr2 rounded-xl bg-back1/40 mt-auto">
