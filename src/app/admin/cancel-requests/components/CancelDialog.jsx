        ...
        <Dialog open={open} onOpenChange={(val) => {
            ...
            <DialogContent className="sm:max-w-[420px] max-h-[85vh] bg-white rounded-2xl border border-slate-200 shadow-none p-6">
                <DialogHeader className="border-b border-slate-100 pb-3 mb-2">
                    <DialogTitle className="text-lg font-bold text-slate-800">Cancel Order?</DialogTitle>
                </DialogHeader>
                ...
                <div className="mt-2 space-y-2">
                    <Label htmlFor="reason" className="text-xs font-bold uppercase tracking-wider text-slate-400">Reason for cancellation</Label>
                    <Textarea
                        id="reason"
